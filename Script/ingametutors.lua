...
local tutors = {
                     ...
                     boss       = "And there it is!\n\nThe evil Arachmalum, destroyer of realms!\n\nIt's up to you to defeat it now, Cynthia!\n\nIt will spew poison killing you instantly every three actions you make.\n\nIf you can hit it 10 times with a rock, it will die, so you can finish this puzzle and the game!\n\nNow that you've come this far, don't mess it up!\n\nGood luck, Cynthia!"
               }
...
local function tutor(tag)
    ...
    hate.graphics.present() -- Make sure the puzzle shows!
    hate.window.showMessageBox( "Tutorial", tutors[tag] , "error", true )
    saveuser()
end    
