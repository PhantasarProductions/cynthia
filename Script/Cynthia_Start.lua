-- <License Block>
-- src/Tricky/Script/Cynthia_Start.lua
-- Start up File (Cynthia Johnson's start file, normally applied by my old love project builder, but manually adapted for Cynthia Johnson)
-- version: 22.07.17
...
love.window.setTitle("Cynthia Johnson")
