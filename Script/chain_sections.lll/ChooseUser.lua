                      ...
                      action = function(g)
                        ...
                        if cu.chosenname then
                          if user.username==cu.chosenname then
                            ...
                            love.filesystem.remove("users/"..cu.chosenname..".lua")
                            love.window.showMessageBox( "Cynthia Johnson", "R.I.P.\n"..cu.chosenname,"info")
                            chain.go("CHOOSEUSER")
                          end
                        else  
...
function cu.arrive()
  cu.UserButtons={}
  cu.chosenname = nil
  local d = love.filesystem.getDirectoryItems("users")
  local cnt = 0
  local toomuch = 0
